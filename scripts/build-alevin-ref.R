...
refpath<-"/Users/larisamorales/Documents/HGMS/workshops/micm_singlecell/data/references/gencode.GRCm38.vM24"
mode<-'generate'
...
if(mode=='generate'){
    ...
    tximeta::makeLinkedTxome(
        indexDir = paste(refpath,"/gencode.vM24.annotation.expanded.sidx",sep=""), 
        source = "GENCODE", 
        genome = "GRCm38", 
        organism = "Mus musculus", 
        release = "M24", 
        fasta = paste(refpath,"/gencode.vM24.annotation.expanded.fa",sep=""), 
        gtf = paste(refpath,"/gencode.vM24.annotation.expanded.gtf",sep=""), 
        write = TRUE, 
        jsonFile = paste(refpath,"/gencode.vM24.annotation.expanded.json",sep=""))
